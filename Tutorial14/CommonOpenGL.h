 ...
 *
 *
 *  Created by Mike Daley on 19/03/2011.
 *  Copyright 2011 71Squared. All rights reserved.
 *
 */
...
// Returns an SSColor structure from the values passed in
static inline SSColor SSColorMake(GLfloat r, GLfloat g, GLfloat b, GLfloat a)
{
    SSColor newColor;
    newColor.red = r;
    newColor.green = g;
